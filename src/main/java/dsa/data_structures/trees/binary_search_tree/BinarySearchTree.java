package dsa.data_structures.trees.binary_search_tree;
            ...
            while (true) {
                ...
                if (current.value < value) {
                    if (current.right != null) {
                        current = current.right; // got next right
                    } else {
                        current.right = newNode; // current right node is empty so assign to it
                        break;
                    }
                    // left
                } else {
...
//         1    6   15    170
    ...
    //    System.out.println("look for 20: " + bst.lookup(20).value);
